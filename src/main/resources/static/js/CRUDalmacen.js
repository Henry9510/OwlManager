...
let editarInsumo = async (ubicacion) => {
    ...
    try {
        ...
        document.getElementById("codigo_insumo").value = insumo.insumo.codigo_insumo;
        document.getElementById("nombre").value = insumo.insumo.nombre;
        document.getElementById("numero_parte").value = insumo.insumo.numero_parte;
        document.getElementById("procedencia").value = insumo.insumo.procedencia;
        document.getElementById("stock").value = insumo.stock;

        // Seleccionar la unidad y categoría actuales en los selects
        document.getElementById('unidad').value = insumo.insumo.unidades_insumo.codigo_unidades;
        document.getElementById('categoria_insumo').value = insumo.insumo.categoria_insumo.codigo_categoria;
...
let aplicarActualizacionProducto = async () => {
    ...
    try {
        ...
        aplicarActualizacionAlmacen(idEditar);
            ...
            let contenidoFila = `
                <tr>
                  <td>${insumo.ubicacion}</td>
                    <td>${insumo.insumo.codigo_insumo}</td>
                    <td>${insumo.insumo.nombre}</td>
                    <td>${insumo.insumo.numero_parte}</td>
                    <td>${insumo.insumo.unidades_insumo.nombre_unidad}</td> 
                    <td>${insumo.insumo.procedencia}</td>
                    <td>${insumo.insumo.categoria_insumo.nombre_categoria}</td> 
                    <td>${insumo.stock}</td>
